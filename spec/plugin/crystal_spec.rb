...
describe "crystal" do
  ...
  after :each do
    vim.command('silent! unlet g:splitjoin_crystal_trailing_comma')
    vim.command('silent! unlet g:splitjoin_crystal_heredoc_type')
    vim.command('silent! unlet g:splitjoin_crystal_hanging_args')
    vim.command('silent! unlet g:splitjoin_crystal_do_block_split')
  end
  ...
  specify "hashes without a trailing comma" do
    vim.command('let g:splitjoin_crystal_trailing_comma = 0')
  ...
  describe "blocks" do
    ...
    it "splits {}-blocks into {}-blocks depending on a setting" do
      vim.command('let g:splitjoin_crystal_do_block_split = 0')
  ...
  describe "heredocs" do
    ...
    it "can use the << heredoc style" do
      vim.command('let g:splitjoin_crystal_heredoc_type = "<<"')
  ...
  describe "method arguments" do
    specify "with hanging args" do
      vim.command('let g:splitjoin_crystal_hanging_args = 1')
    ...
    specify "without hanging args" do
      vim.command('let g:splitjoin_crystal_hanging_args = 0')
  ...
  describe "method options" do
    specify "with curly braces" do
      vim.command('let g:splitjoin_crystal_curly_braces = 1')
    ...
    specify "without curly braces" do
      vim.command('let g:splitjoin_crystal_curly_braces = 0')
