...
call sj#settings#SetDefault('crystal_curly_braces',                    1)
call sj#settings#SetDefault('crystal_heredoc_type',                    '<<-')
call sj#settings#SetDefault('crystal_trailing_comma',                  0)
call sj#settings#SetDefault('crystal_hanging_args',                    1)
call sj#settings#SetDefault('crystal_do_block_split',                  1)
